...
async function onSearch(e) {
    ...
    try {
        const URL = await (0, _axiosDefault.default).get(`${BASE_URL}?key=${API_KEY}&q=${searchQuery}&image_type=photo&orientation=horizontal&safesearch=true&per_page=${perPage}&page=${page}`);
        if (URL.data.hits.length === 0) (0, _notiflixDefault.default).Notify.warning("\u274C Sorry, there are no images matching your search query. Please try again.", {
            timeout: 2000
        });
        totalHitsOfResponse = URL.data.totalHits;
        totalPageOfResponse = Math.floor(totalHitsOfResponse / perPage);
        if (URL.data.hits.length > 0) (0, _notiflixDefault.default).Notify.success(` We found ${totalHitsOfResponse} images.`, {
            timeout: 2000
        });
        refs.imagesContainer.innerHTML = "";
        (0, _markupDefault.default)(URL.data);
        page += 1;
    } catch (error) {
        console.log(error);
    }
...
async function fetchImages() {
    ...
    try {
        const URL = await (0, _axiosDefault.default).get(`${BASE_URL}?key=${API_KEY}&q=${searchQuery}&image_type=photo&orientation=horizontal&safesearch=true&per_page=40&page=${page}`);
        if (URL.data.hits.length === 0 || totalPageOfResponse === page) (0, _notiflixDefault.default).Notify.warning("We're sorry, but this is the last page.");
        console.log(page);
        (0, _markupDefault.default)(URL.data);
    } catch (error) {
        console.log(error);
...
},{"axios":"jo6P5","notiflix":"5WWYd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix/dist/notiflix-3.2.5.min.css":"jvRD8","./get-refs":"jXJiK","./markup":"avFhm"}],"jo6P5":[function(require,module,exports) {
...
},{}],"jvRD8":[function() {},{}],"jXJiK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var _getRefsDefault = parcelHelpers.interopDefault(_getRefs);
const refs = (0, _getRefsDefault.default)();
function renderMarkupImageInfo(galleryItems) {
...
exports.default = renderMarkupImageInfo;
...
},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./get-refs":"jXJiK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ydBq":[function(require,module,exports) {
/*!
